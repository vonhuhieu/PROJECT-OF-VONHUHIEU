                ...
                <div class="col-sm-9">
					<div class="blog-post-area">
						...
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<input type="text" name="name" placeholder="Mời nhập tên sản phẩm">
							@error('name')
							...
							<input type="text" name="price" placeholder="Mời nhập giá sản phẩm">
							@error('price')
								<p style="color: red">{{ $message }}</p>
							@enderror
							<br></br>
							...
							<div id="sale">
								...
								<input type="text" name="sale" placeholder="Mời nhập % sale">
								@error('sale')
								<p style="color: red">{{ $message }}</p>
							@enderror
								<br></br>
							...
							<input type="text" name="company" placeholder="Mời nhập tên công ty">
							@error('company')
								<p style="color: red">{{ $message }}</p>
							@enderror
							<br></br>
							...
							<textarea rows="5" name="detail" placeholder="Mời nhập thông tin chi tiết" id="demo" class="form-control form-control-line"></textarea>
							@error('detail')
								<p style="color: red">{{ $message }}</p>
							@enderror
							<br></br>
